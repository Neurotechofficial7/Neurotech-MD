...
global.channelLink = "https://whatsapp.com/channel/0029Vb6ICxq4IBhLdSYKrp1Y";
global.ytch = "Allamano";
...
async function handleMessages(sock, messageUpdate, printLog) {
    try {
        ...
        if (message.message?.buttonsResponseMessage) {
            ...
            if (buttonId === 'channel') {
                await sock.sendMessage(chatId, {
                    text: '📢 *Join our Channel:*\nhttps://whatsapp.com/channel/0029Vb6ICxq4IBhLdSYKrp1Y'
                }, { quoted: message });
                return;
        ...
        const adminCommands = ['${prefix}mute', 'unmute', '${prefix}ban', '${prefix}unban', '${prefix}promote', '${prefix}demote', '${prefix}kick', '${prefix}tagall', '${prefix}tagnotadmin', '${prefix}hidetag', '${prefix}antilink', '${prefix}antitag', '${prefix}setgdesc', '${prefix}setgname', '${prefix}setgpp'];
        const isAdminCommand = adminCommands.some(cmd => userMessage.startsWith(cmd));

        // List of owner commands
        const ownerCommands = ['${prefix}mode', '${prefix}autostatus', '${prefix}antidelete', '${prefix}cleartmp', '${prefix}setpp', '${prefix}clearsession', '${prefix}areact', '${prefix}autoreact', '${prefix}autotyping', '${prefix}autoread', '${prefix}pmblocker'];
        ...
        switch (true) {
            ...
            case userMessage.startsWith('${prefix}ban'):
                if (!isGroup) {
                    if (!message.key.fromMe && !senderIsSudo) {
                        await sock.sendMessage(chatId, { text: 'Only owner/sudo can use ${prefix}ban in private chat.' }, { quoted: message });
                        break;
                    }
                }
            ...
            case userMessage.startsWith('${prefix}unban'):
                if (!isGroup) {
                    if (!message.key.fromMe && !senderIsSudo) {
                        await sock.sendMessage(chatId, { text: 'Only owner/sudo can use ${prefix}unban in private chat.' }, { quoted: message });
                        break;
                    }
                }
    ...
    break;
            ...
            case userMessage === '${prefix}news':
                ...
                break;
            case userMessage.startsWith('.ttt') || userMessage.startsWith('${prefix}tictactoe'):
            ...
            case userMessage.startsWith('${prefix}setgpp'):
                ...
                break;
            case userMessage.startsWith('.instagram') || userMessage.startsWith('${prefix}insta') || (userMessage === '${prefix}ig' || userMessage.startsWith('${prefix}ig ')):
            ...
            case userMessage.startsWith('${prefix}video') || userMessage.startsWith('${prefix}ytmp4'):
                ...
                break;
            case userMessage.startsWith('${prefix}tiktok') || userMessage.startsWith('.tt'):
            ...
            case userMessage.startsWith('${prefix}ss') || userMessage.startsWith('${prefix}ssweb') || userMessage.startsWith('${prefix}screenshot'):
                const ssCommandLength = userMessage.startsWith('${prefix}screenshot') ? 11 : (userMessage.startsWith('${prefix}ssweb') ? 6 : 3);
            ...
            case userMessage.startsWith('${prefix}update'):
                ...
                commandExecuted = true;
                break;
            case userMessage.startsWith('.removebg') || userMessage.startsWith('${prefix}rmbg') || userMessage.startsWith('${prefix}nobg'):
