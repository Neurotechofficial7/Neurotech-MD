/**
 * Neurotech Official - A WhatsApp Bot
 * Copyright (c) 2026 Allamano 
 * 
...
const { smsg, isUrl, generateMessageTag, getBuffer, getSizeMedia, fetch, wait, sleep, reSize } = require('./lib/myfunc')
const {
...
let phoneNumber = "254785760508"
let owner = JSON.parse(fs.readFileSync('./data/owner.json'))

global.botname = "NEUROTECH OFFICIAL"
global.themeemoji = "•"
...
async function startXeonBotInc() {
    ...
    if (pairingCode && !XeonBotInc.authState.creds.registered) {
        ...
        if (!!global.phoneNumber) {
            ...
            phoneNumber = await question(chalk.bgBlack(chalk.greenBright(`Please type your WhatsApp number 😍\nFormat: 254776730 (without + or spaces) : `)))
        }
        ...
        if (connection == "open") {
            ...
            try {
                ...
                await XeonBotInc.sendMessage(botNumber, {
                    text: `🤖 SYSTEM ONLINE — CONNECTION ESTABLISHED!\n\n⏰ Time: ${new Date().toLocaleString()}\n\n✅ BOT STATUS: FULLY ACTIVE! \n\n💡 Have ideas or found a bug? Message the owner to report errors or suggest what we should add in the next update! DM 254785760507\n\n✅Make sure to join below channel for daily giveaways,Bot updates and free bot deployment from adim`,
                    contextInfo: {
                        forwardingScore: 1,
                        isForwarded: true,
                        forwardedNewsletterMessageInfo: {
            ...
            for (const call of calls) {
                ...
                try {
                    ...
                    if (!antiCallNotified.has(callerJid)) {
                        ...
                        await XeonBotInc.sendMessage(callerJid, { text: '📵 Anticall is enabled. Your call was rejected and you will be blocked if you continue calling.' });
                    }
                } catch {}
